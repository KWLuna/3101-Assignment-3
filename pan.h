...
#define PanSource	"vending_machine.pml"
...
#define _nstates2	14	/* user */
#define minseq2	28
#define maxseq2	40
#define _endstate2	13

#define _nstates1	14	/* machine_controller */
#define minseq1	15
#define maxseq1	27
#define _endstate1	13

#define _nstates0	16	/* gate */
#define minseq0	0
#define maxseq0	14
...
#define Puser	((P2 *)_this)
typedef struct P2 { /* user */
...
#define Pmachine_controller	((P1 *)_this)
typedef struct P1 { /* machine_controller */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 3; /* proctype */
	unsigned _p   : 5; /* state    */
#ifdef HAS_PRIORITY
...
#define Pgate	((P0 *)_this)
typedef struct P0 { /* gate */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 3; /* proctype */
	unsigned _p   : 5; /* state    */
#ifdef HAS_PRIORITY
...
typedef struct State {
	...
	uchar v;
	uchar selected_item;
	uchar user_controller_ch;
	uchar gate_user_ch;
	uchar gate_controller_ch;
#ifdef TRIX
